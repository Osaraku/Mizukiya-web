        ...
        <div class="container">
            <form action="/admin/dashboard" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Staff"
                        required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Alamat Staff"
                        required>
                </div>
                <div class="form-group">
