        ...
        <div class="container">
            <form action="/admin/promo" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="awal_promo" id="awal_promo" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="akhir_promo"><b>Akhir Promo</b></label>
                    <input type="date" name="akhir_promo" id="akhir_promo" class="form-control" required>
                </div>
                ...
                <div class="form-group">
                    <input type="submit" value="Tambah Promo" class="btn btn-primary py-3 px-5 mt-3">
                </div>
            </form>
        </div>
    </section>
