...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="/">Mizukiya (Admin)</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item @yield('admin-dashboard')"><a href="{{ url('/admin/dashboard') }}"
                            class="nav-link">Dashboard</a>
                    </li>
                    <li class="nav-item @yield('admin-menu')"><a href="{{ url('/admin/menu') }}" class="nav-link">Menu</a>
                    </li>
                    <li class="nav-item @yield('admin-reservasi')"><a href="{{ url('/admin/reservasi') }}"
